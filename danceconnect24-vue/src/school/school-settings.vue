<template>
  ...
  <div class="home">
    <div class="home-content">
      <div class="home-left">
        <h2>My account</h2>
        <p>Nickname: School</p>
        <p>E-mail: school@gmail.com</p>
      </div>
      <div class="home-right">
        <h2>Change data</h2>
        <div class="home-right-buttons">
          <button class="home-right-btn" @click="redirectToChangeEmail">
            <p>Change E-mail</p>
            <svg
              width="22"
              height="19"
          ...
          <button class="home-right-btn" @click="redirectToChangePassword">
            <p>Change Password</p>
            <svg
              width="22"
              height="19"
  ...
  <div class="confirmation" :class="{ active: isConfirmationActive }">
    <div class="confirmation-content">
      ...
      <p>Are you sure you want to delete your school account?</p>
...
export default {
  ...
  methods: {
    ...
    redirectToChangeEmail() {
      this.$router.push("/school-change-email");
    },
    redirectToChangePassword() {
      this.$router.push("/school-change-password");
    },
    async showDelete() {
      try {
        ...
        const token = localStorage.getItem("token");
        axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;
        await axios.post("http://localhost:8000/school/delete-account", {
          user_id: userId,
        });
        localStorage.clear();
        this.$router.push("/");
